...
export const clients: Account[] = [
  ...
  // ============ NEW POSITIVE CLIENTS (16-25) ============
  {
    ...
    interests: ['bonds', 'fixed income', 'dividend stocks'],
    preferred_contact: 'phone',
  },
  {
    id: 'client_017',
    ...
    interests: ['treasury bonds', 'blue chip', 'municipal bonds'],
    preferred_contact: 'email',
  },
  {
    id: 'client_018',
    ...
    interests: ['index funds', 'etfs', 'diversified portfolios'],
    preferred_contact: 'phone',
  },
  {
    id: 'client_019',
    ...
    interests: ['dividend stocks', 'bonds', 'retirement income'],
    preferred_contact: 'meeting',
  },
  {
    id: 'client_020',
    ...
    income: 125000,
    risk_profile: 'low',
    portfolio_value: 158000,
    total_investments: 4,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-07',
    conversion_probability: 85,
    interests: ['balanced funds', 'etfs', 'target date funds'],
    preferred_contact: 'email',
  },
  {
    id: 'client_021',
    ...
    name: 'Barbara Scott',
    email: 'barbara.scott@email.com',
    phone: '+1-555-0121',
    age: 47,
    income: 175000,
    risk_profile: 'medium',
    portfolio_value: 295000,
    total_investments: 5,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-11',
    conversion_probability: 91,
    interests: ['index funds', 'blue chip', 'dividend growth'],
    preferred_contact: 'phone',
  },
  {
    id: 'client_022',
    ...
    income: 250000,
    risk_profile: 'low',
    portfolio_value: 510000,
    total_investments: 8,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-06',
    conversion_probability: 94,
    interests: ['municipal bonds', 'fixed income', 'capital preservation'],
    preferred_contact: 'meeting',
  },
  {
    id: 'client_023',
    ...
    income: 135000,
    risk_profile: 'low',
    portfolio_value: 178000,
    total_investments: 4,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-09',
    conversion_probability: 86,
    interests: ['target date funds', 'bonds', 'stable value'],
    preferred_contact: 'email',
  },
  {
    id: 'client_024',
    ...
    name: 'David Adams',
    email: 'david.adams@email.com',
    phone: '+1-555-0124',
    age: 38,
    income: 155000,
    risk_profile: 'medium',
    portfolio_value: 345000,
    total_investments: 6,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-10',
    conversion_probability: 89,
    interests: ['growth stocks', 'etfs', 'technology'],
    preferred_contact: 'phone',
  },
  {
    id: 'client_025',
    ...
    income: 180000,
    risk_profile: 'low',
    portfolio_value: 225000,
    total_investments: 5,
    lifecycle_stage: 'customer',
    last_contact: '2026-01-08',
    conversion_probability: 87,
    interests: ['blue chip stocks', 'dividend income', 'bonds'],
    preferred_contact: 'meeting',
  },
];
...
export const activities: Activity[] = [
  ...
  // Activities for new positive clients (16-25)
  { id: 'act_019', client_id: 'client_016', type: 'call', date: '2026-01-11', outcome: 'invested', notes: 'Added $30K to bond ladder strategy' },
  { id: 'act_020', client_id: 'client_016', type: 'meeting', date: '2026-01-05', outcome: 'interested', notes: 'Q4 portfolio review - very satisfied' },
  { id: 'act_021', client_id: 'client_017', type: 'email', date: '2026-01-09', outcome: 'interested', notes: 'Sent municipal bond analysis' },
  { id: 'act_022', client_id: 'client_017', type: 'call', date: '2026-01-02', outcome: 'invested', notes: 'Increased fixed income allocation' },
  { id: 'act_023', client_id: 'client_018', type: 'call', date: '2026-01-08', outcome: 'invested', notes: 'Added index fund position' },
  { id: 'act_024', client_id: 'client_018', type: 'email', date: '2026-01-03', outcome: 'interested', notes: 'Shared ETF comparison report' },
  { id: 'act_025', client_id: 'client_019', type: 'meeting', date: '2026-01-10', outcome: 'invested', notes: 'Annual review - added $50K to retirement portfolio' },
  { id: 'act_026', client_id: 'client_019', type: 'call', date: '2026-01-04', outcome: 'interested', notes: 'Discussed dividend reinvestment strategy' },
  { id: 'act_027', client_id: 'client_020', type: 'email', date: '2026-01-07', outcome: 'interested', notes: 'Target date fund rebalancing discussion' },
  { id: 'act_028', client_id: 'client_020', type: 'call', date: '2025-12-30', outcome: 'invested', notes: 'Increased 401k contribution' },
  { id: 'act_029', client_id: 'client_021', type: 'call', date: '2026-01-11', outcome: 'invested', notes: 'Added dividend growth fund' },
  { id: 'act_030', client_id: 'client_021', type: 'meeting', date: '2026-01-06', outcome: 'interested', notes: 'Quarterly review - exceeded expectations' },
  { id: 'act_031', client_id: 'client_022', type: 'meeting', date: '2026-01-06', outcome: 'invested', notes: 'Estate planning investment review' },
  { id: 'act_032', client_id: 'client_022', type: 'call', date: '2025-12-28', outcome: 'interested', notes: 'Discussed tax-efficient strategies' },
  { id: 'act_033', client_id: 'client_023', type: 'email', date: '2026-01-09', outcome: 'interested', notes: 'Sent retirement projection update' },
  { id: 'act_034', client_id: 'client_023', type: 'call', date: '2026-01-03', outcome: 'invested', notes: 'Rolled over old 401k' },
  { id: 'act_035', client_id: 'client_024', type: 'call', date: '2026-01-10', outcome: 'invested', notes: 'Added tech ETF position' },
  { id: 'act_036', client_id: 'client_024', type: 'email', date: '2026-01-05', outcome: 'interested', notes: 'Growth stock analysis shared' },
  { id: 'act_037', client_id: 'client_025', type: 'meeting', date: '2026-01-08', outcome: 'invested', notes: 'Added income-focused holdings' },
  { id: 'act_038', client_id: 'client_025', type: 'call', date: '2026-01-02', outcome: 'interested', notes: 'Discussed dividend portfolio expansion' },
];
...
export const portfolioHoldings: PortfolioHolding[] = [
  ...
  // Portfolio holdings for new positive clients (16-25)
  { client_id: 'client_016', investment_id: 'inv_003', amount_invested: 120000, current_value: 125400, purchase_date: '2025-02-15', performance: 4.5 },
  { client_id: 'client_016', investment_id: 'inv_006', amount_invested: 100000, current_value: 105800, purchase_date: '2025-04-10', performance: 5.8 },
  { client_id: 'client_016', investment_id: 'inv_005', amount_invested: 80000, current_value: 86800, purchase_date: '2025-06-20', performance: 8.5 },
  { client_id: 'client_017', investment_id: 'inv_003', amount_invested: 85000, current_value: 88825, purchase_date: '2025-03-01', performance: 4.5 },
  { client_id: 'client_017', investment_id: 'inv_006', amount_invested: 60000, current_value: 63480, purchase_date: '2025-05-15', performance: 5.8 },
  { client_id: 'client_018', investment_id: 'inv_002', amount_invested: 100000, current_value: 110200, purchase_date: '2025-01-20', performance: 10.2 },
  { client_id: 'client_018', investment_id: 'inv_005', amount_invested: 90000, current_value: 97650, purchase_date: '2025-04-05', performance: 8.5 },
  { client_id: 'client_019', investment_id: 'inv_003', amount_invested: 150000, current_value: 156750, purchase_date: '2024-11-10', performance: 4.5 },
  { client_id: 'client_019', investment_id: 'inv_006', amount_invested: 120000, current_value: 126960, purchase_date: '2025-01-25', performance: 5.8 },
  { client_id: 'client_019', investment_id: 'inv_005', amount_invested: 100000, current_value: 108500, purchase_date: '2025-05-01', performance: 8.5 },
  { client_id: 'client_020', investment_id: 'inv_002', amount_invested: 70000, current_value: 77140, purchase_date: '2025-03-15', performance: 10.2 },
  { client_id: 'client_020', investment_id: 'inv_003', amount_invested: 50000, current_value: 52250, purchase_date: '2025-06-01', performance: 4.5 },
  { client_id: 'client_021', investment_id: 'inv_002', amount_invested: 110000, current_value: 121220, purchase_date: '2025-02-10', performance: 10.2 },
  { client_id: 'client_021', investment_id: 'inv_005', amount_invested: 95000, current_value: 103075, purchase_date: '2025-04-20', performance: 8.5 },
  { client_id: 'client_022', investment_id: 'inv_003', amount_invested: 200000, current_value: 209000, purchase_date: '2024-08-15', performance: 4.5 },
  { client_id: 'client_022', investment_id: 'inv_006', amount_invested: 180000, current_value: 190440, purchase_date: '2024-10-01', performance: 5.8 },
  { client_id: 'client_022', investment_id: 'inv_005', amount_invested: 80000, current_value: 86800, purchase_date: '2025-01-10', performance: 8.5 },
  { client_id: 'client_023', investment_id: 'inv_003', amount_invested: 80000, current_value: 83600, purchase_date: '2025-04-01', performance: 4.5 },
  { client_id: 'client_023', investment_id: 'inv_002', amount_invested: 60000, current_value: 66120, purchase_date: '2025-06-15', performance: 10.2 },
  { client_id: 'client_024', investment_id: 'inv_001', amount_invested: 100000, current_value: 115500, purchase_date: '2025-02-20', performance: 15.5 },
  { client_id: 'client_024', investment_id: 'inv_002', amount_invested: 120000, current_value: 132240, purchase_date: '2025-03-10', performance: 10.2 },
  { client_id: 'client_024', investment_id: 'inv_005', amount_invested: 80000, current_value: 86800, purchase_date: '2025-05-25', performance: 8.5 },
  { client_id: 'client_025', investment_id: 'inv_005', amount_invested: 100000, current_value: 108500, purchase_date: '2025-01-15', performance: 8.5 },
  { client_id: 'client_025', investment_id: 'inv_006', amount_invested: 80000, current_value: 84640, purchase_date: '2025-03-20', performance: 5.8 },
];
